...
"[project]/node_modules/.pnpm/node-fetch-native@1.6.6/node_modules/node-fetch-native/dist/shared/node-fetch-native.DfbY2q-x.mjs [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/.pnpm/node-fetch-native@1.6.6/node_modules/node-fetch-native/dist/node.mjs [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$shared$2f$node$2d$fetch$2d$native$2e$DfbY2q$2d$x$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/node-fetch-native@1.6.6/node_modules/node-fetch-native/dist/shared/node-fetch-native.DfbY2q-x.mjs [app-rsc] (ecmascript)");
...
function ts(i1) {
    ...
    const S = u ? "base64" : "ascii", E = unescape(i1.substring(o + 1)), w = Buffer.from(E, S);
...
function ns() {
    return vo || (vo = 1, function(i1, o) {
        (function(a, l) {
            ...
            class pn {
                ...
                _nextSteps() {
                    ...
                    return et(t, {
                        ...
                        _closeSteps: n(()=>{
                            this._ongoingPromise = void 0, this._isFinished = !0, ue(t), r({
                                value: void 0,
                                done: !0
                            });
                        }, "_closeSteps"),
                        _errorSteps: n((d)=>{
                            this._ongoingPromise = void 0, this._isFinished = !0, ue(t), s(d);
                        }, "_errorSteps")
                    }), f;
                }
                _returnSteps(t) {
            ...
            let fe = n((e)=>(typeof e.transfer == "function" ? fe = n((t)=>t.transfer(), "TransferArrayBuffer") : typeof structuredClone == "function" ? fe = n((t)=>structuredClone(t, {
                        transfer: [
                            t
                        ]
                    }), "TransferArrayBuffer") : fe = n((t)=>t, "TransferArrayBuffer"), fe(e)), "TransferArrayBuffer"), _e = n((e)=>(typeof e.detached == "boolean" ? _e = n((t)=>t.detached, "IsDetachedBuffer") : _e = n((t)=>t.byteLength === 0, "IsDetachedBuffer"), _e(e)), "IsDetachedBuffer");
            function Rn(e, t, r) {
            ...
            function Wn(e, t) {
                ...
                p >= t.minimumFill && (f = p - t.bytesFilled, c = !0);
                const R = e._queue;
                for(; f > 0;){
            ...
            function Ti(e) {
                ...
                return t._state !== "readable" || e._closeRequested || !e._started ? !1 : !!(mn(t) && gt(t) > 0 || Br(t) && Dn(t) > 0 || Fn(e) > 0);
            }
            ...
            function zn(e, t, r, s, f, c, d) {
                t._controlledReadableByteStream = e, t._pullAgain = !1, t._pulling = !1, t._byobRequest = null, t._queue = t._queueTotalSize = void 0, Se(t), t._closeRequested = !1, t._started = !1, t._strategyHWM = c, t._pullAlgorithm = s, t._cancelAlgorithm = f, t._autoAllocateChunkSize = d, t._pendingPullIntos = new M, e._readableStreamController = t;
                const p = r();
                g(T(p), ()=>(t._started = !0, Be(t), null), (R)=>(Z(t, R), null));
            }
            ...
            function Ei(e, t) {
                ...
                const r = e?.mode;
                return {
                    mode: r === void 0 ? void 0 : vi(r, `${t} has member 'mode' that`)
                };
            }
            ...
            function Ai(e, t) {
                ...
                return {
                    min: mr(s, `${t} has member 'min' that`)
                };
            }
            ...
            function $n(e, t, r, s) {
                ...
                f._disturbed = !0, f._state === "errored" ? s._errorSteps(f._storedError) : Si(f._readableStreamController, t, r, s);
            }
            ...
            function At(e, t) {
                ...
                return {
                    ...
                    size: s === void 0 ? void 0 : ki(s, `${t} has member 'size' that`)
                };
            }
            ...
            function qi(e, t) {
                ...
                return {
                    abort: r === void 0 ? void 0 : Oi(r, e, `${t} has member 'abort' that`),
                    close: s === void 0 ? void 0 : Ii(s, e, `${t} has member 'close' that`),
                    start: f === void 0 ? void 0 : Fi(f, e, `${t} has member 'start' that`),
                    write: d === void 0 ? void 0 : zi(d, e, `${t} has member 'write' that`),
                    type: c
                };
            }
            n(qi, "convertUnderlyingSink");
            function Oi(e, t, r) {
                return G(e, r), (s)=>z(e, t, [
                        s
                    ]);
            }
            ...
            function Fi(e, t, r) {
                return G(e, r), (s)=>O(e, t, [
                        s
                    ]);
            }
            n(Fi, "convertUnderlyingSinkStartCallback");
            function zi(e, t, r) {
                return G(e, r), (s, f)=>z(e, t, [
                        s,
                        f
                    ]);
            }
            ...
            function Kn(e, t, r, s, f, c, d, p) {
                t._controlledWritableStream = e, e._writableStreamController = t, t._queue = void 0, t._queueTotalSize = void 0, Se(t), t._abortReason = void 0, t._abortController = Di(), t._started = !1, t._strategySizeAlgorithm = p, t._strategyHWM = d, t._writeAlgorithm = s, t._closeAlgorithm = f, t._abortAlgorithm = c;
                const R = Fr(t);
                Or(e, R);
                const y = r(), C = T(y);
                g(C, ()=>(t._started = !0, qt(t), null), (P)=>(t._started = !0, Wr(e, P), null));
            }
            ...
            function la() {
                ...
                if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$shared$2f$node$2d$fetch$2d$native$2e$DfbY2q$2d$x$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["c"] < "u") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$shared$2f$node$2d$fetch$2d$native$2e$DfbY2q$2d$x$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["c"];
            }
            n(la, "getGlobals");
            const $r = la();
            function fa(e) {
                ...
                return A((C, P)=>{
                    ...
                    if (c !== void 0) {
                        if (B = n(()=>{
                            ...
                            s || v.push(()=>t._state === "writable" ? Bt(t, _) : T(void 0)), f || v.push(()=>e._state === "readable" ? X(e, _) : T(void 0)), x(()=>Promise.all(v.map((W)=>W())), !0, _);
                    ...
                    if (n(Ne, "pipeStep"), me(e, d._closedPromise, (_)=>(s ? K(!0, _) : x(()=>Bt(t, _), !0, _), null)), me(t, p._closedPromise, (_)=>(f ? K(!0, _) : x(()=>X(e, _), !0, _), null)), U(e, d._closedPromise, ()=>(r ? K() : x(()=>Zi(p)), null)), oe(t) || t._state === "closed") {
                    ...
                    function x(_, v, W) {
                        if (R) return;
                        R = !0, t._state === "writable" && !oe(t) ? V(Ee(), Y) : Y();
                        function Y() {
                    ...
                    function K(_, v) {
                        R || (R = !0, t._state === "writable" && !oe(t) ? V(Ee(), ()=>be(_, v)) : be(_, v));
                    }
                    n(K, "shutdown");
                    function be(_, v) {
            ...
            function io(e) {
                ...
                return !Ue(e) || !e._started ? !1 : !!(Ce(t) && gt(t) > 0 || Mr(e) > 0);
            }
            ...
            function Oe(e) {
                if (!Ue(e)) return;
                const t = e._controlledReadableStream;
                e._closeRequested = !0, e._queue.length === 0 && (jt(e), lt(t));
            }
            n(Oe, "ReadableStreamDefaultControllerClose");
            function Me(e, t) {
                if (!Ue(e)) return;
                const r = e._controlledReadableStream;
                if (Ce(r) && gt(r) > 0) pr(r, t, !1);
                else {
                    let s;
                    try {
            ...
            function ao(e, t, r, s, f, c, d) {
                t._controlledReadableStream = e, t._queue = void 0, t._queueTotalSize = void 0, Se(t), t._started = !1, t._closeRequested = !1, t._pullAgain = !1, t._pulling = !1, t._strategySizeAlgorithm = d, t._strategyHWM = c, t._pullAlgorithm = s, t._cancelAlgorithm = f, e._readableStreamController = t;
                const p = r();
                g(T(p), ()=>(t._started = !0, st(t), null), (R)=>(J(t, R), null));
            }
            n(ao, "SetUpReadableStreamDefaultController");
            function ba(e, t, r, s) {
                const f = Object.create(he.prototype);
                let c, d, p;
                t.start !== void 0 ? c = n(()=>t.start(f), "startAlgorithm") : c = n(()=>{}, "startAlgorithm"), t.pull !== void 0 ? d = n(()=>t.pull(f), "pullAlgorithm") : d = n(()=>T(void 0), "pullAlgorithm"), t.cancel !== void 0 ? p = n((R)=>t.cancel(R), "cancelAlgorithm") : p = n(()=>T(void 0), "cancelAlgorithm"), ao(e, f, c, d, p, r, s);
            }
            ...
            function ya(e, t) {
                const r = ze(e);
                let s = !1, f = !1, c = !1, d = !1, p, R, y, C, P;
                const B = A((U)=>{
                    P = U;
                });
                function ee() {
                    return s ? (f = !0, T(void 0)) : (s = !0, et(r, {
                        _chunkSteps: n((x)=>{
                            se(()=>{
                                f = !1;
                                const K = x, be = x;
                                c || Me(y._readableStreamController, K), d || Me(C._readableStreamController, be), s = !1, f && ee();
                            });
                        }, "_chunkSteps"),
                        _closeSteps: n(()=>{
                ...
                function me() {}
                return n(me, "startAlgorithm"), y = ut(me, ee, Ne), C = ut(me, ee, Ee), I(r._closedPromise, (U)=>(J(y._readableStreamController, U), J(C._readableStreamController, U), (!c || !d) && P(void 0), null)), [
                    y,
                    C
                ];
            }
            ...
            function ga(e) {
                let t = ze(e), r = !1, s = !1, f = !1, c = !1, d = !1, p, R, y, C, P;
                const B = A((_)=>{
                    P = _;
                });
                function ee(_) {
                    ...
                    We(t) && (ue(t), t = ze(e), ee(t)), et(t, {
                        _chunkSteps: n((v)=>{
                            se(()=>{
                                ...
                                c || Tt(y._readableStreamController, W), d || Tt(C._readableStreamController, Y), r = !1, s ? me() : f && U();
                            });
                        }, "_chunkSteps"),
                        _closeSteps: n(()=>{
                ...
                function be() {}
                return n(be, "startAlgorithm"), y = uo(be, me, x), C = uo(be, U, K), ee(t), [
                    y,
                    C
                ];
            }
            ...
            function Ta(e, t) {
                ...
                return {
                    autoAllocateChunkSize: s === void 0 ? void 0 : mr(s, `${t} has member 'autoAllocateChunkSize' that`),
                    cancel: f === void 0 ? void 0 : Ca(f, r, `${t} has member 'cancel' that`),
                    pull: c === void 0 ? void 0 : Pa(c, r, `${t} has member 'pull' that`),
                    start: d === void 0 ? void 0 : Ea(d, r, `${t} has member 'start' that`),
                    type: p === void 0 ? void 0 : va(p, `${t} has member 'type' that`)
                };
            }
            ...
            function so(e, t) {
                ...
                return c !== void 0 && Ba(c, `${t} has member 'signal' that`), {
                    preventAbort: !!r,
                    preventCancel: !!s,
                    preventClose: !!f,
                    signal: c
            ...
            function Wa(e, t) {
                ...
                const s = e?.writable;
                return dr(s, "writable", "ReadableWritablePair"), Un(s, `${t} has member 'writable' that`), {
                    readable: r,
                    writable: s
                };
            }
            ...
            function fo(e, t) {
                ...
                return dr(r, "highWaterMark", "QueuingStrategyInit"), {
                    highWaterMark: hr(r)
                };
            }
            ...
            function ka(e, t) {
                ...
                return {
                    cancel: r === void 0 ? void 0 : Fa(r, e, `${t} has member 'cancel' that`),
                    flush: s === void 0 ? void 0 : qa(s, e, `${t} has member 'flush' that`),
                    readableType: f,
                    start: c === void 0 ? void 0 : Oa(c, e, `${t} has member 'start' that`),
                    transform: d === void 0 ? void 0 : Ia(d, e, `${t} has member 'transform' that`),
                    writableType: p
                };
            }
            ...
            function za(e, t, r, s, f, c) {
                ...
                n(P, "cancelAlgorithm"), e._readable = ut(d, C, P, f, c), e._backpressure = void 0, e._backpressureChangePromise = void 0, e._backpressureChangePromise_resolve = void 0, Ut(e, !0), e._transformStreamController = void 0;
            }
    ...
    try {
        ...
        o && !o.prototype.stream && (o.prototype.stream = n(function(l) {
            ...
            return new ReadableStream({
                type: "bytes",
                async pull (h) {
                    const E = await m.slice(u, Math.min(m.size, u + i1)).arrayBuffer();
...
n(os, "requireStreams"), os(); /*! fetch-blob. MIT License. Jimmy Wärting <https://jimmy.warting.se/opensource> */ 
const Bo = 65536;
async function* Qr(i1, o = !0) {
...
const Wo = class on {
    ...
    async text() {
        ...
        let a = "";
        for await (const l of Qr(this.#e, !1))a += o.decode(l, {
            stream: !0
        });
        return a += o.decode(), a;
    }
    async arrayBuffer() {
        ...
        let a = 0;
        for await (const l of Qr(this.#e, !1))o.set(l, a), a += l.length;
        return o.buffer;
    }
    stream() {
        const o = Qr(this.#e, !0);
...
}, Yr = is; /*! formdata-polyfill. MIT License. Jimmy Wärting <https://jimmy.warting.se/opensource> */ 
var { toStringTag: dt, iterator: as, hasInstance: ss } = Symbol, ko = Math.random, us = "append,set,get,getAll,delete,keys,values,entries,forEach,constructor".split(","), qo = n((i1, o, a)=>(i1 += "", /^(Blob|File)$/.test(o && o[dt]) ? [
        (a = a !== void 0 ? a + "" : o[dt] == "File" ? o.name : "blob", i1),
        o.name !== a || o[dt] == "blob" ? new Yr([
            o
        ], a, o) : o
    ] : [
        i1,
        o + ""
    ]), "f"), Gr = n((i1, o)=>(o ? i1 : i1.replace(/\r?\n|\r/g, `\r
`)).replace(/\n/g, "%0A").replace(/\r/g, "%0D").replace(/"/g, "%22"), "e$1"), Fe = n((i1, o, a)=>{
...
Content-Disposition: form-data; name="`;
    return i1.forEach((m, h)=>typeof m == "string" ? l.push(u + Gr(h) + `"\r
\r
${m.replace(/\r(?!\n)|(?<!\r)\n/g, `\r
`)}\r
...
const Jt = Symbol.toStringTag, Oo = n((i1)=>typeof i1 == "object" && typeof i1.append == "function" && typeof i1.delete == "function" && typeof i1.get == "function" && typeof i1.getAll == "function" && typeof i1.has == "function" && typeof i1.set == "function" && typeof i1.sort == "function" && i1[Jt] === "URLSearchParams", "isURLSearchParameters"), Xt = n((i1)=>i1 && typeof i1 == "object" && typeof i1.arrayBuffer == "function" && typeof i1.type == "string" && typeof i1.stream == "function" && typeof i1.constructor == "function" && /^(Blob|File)$/.test(i1[Jt]), "isBlob"), fs = n((i1)=>typeof i1 == "object" && (i1[Jt] === "AbortSignal" || i1[Jt] === "EventTarget"), "isAbortSignal"), cs = n((i1, o)=>{
    const a = new URL(o).hostname, l = new URL(i1).hostname;
    return a === l || a.endsWith(`.${l}`);
}, "isDomainOrSubdomain"), ds = n((i1, o)=>{
    const a = new URL(o).protocol, l = new URL(i1).protocol;
    return a === l;
}, "isSameProtocol"), hs = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$util__$5b$external$5d$__$28$node$3a$util$2c$__cjs$29$__["promisify"])(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["default"].pipeline), N = Symbol("Body internals");
class ht {
    static{
        n(this, "Body");
    }
    constructor(o, { size: a = 0 } = {}){
        let l = null;
        o === null ? o = null : Oo(o) ? o = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(o.toString()) : Xt(o) || __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].isBuffer(o) || (__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$util__$5b$external$5d$__$28$node$3a$util$2c$__cjs$29$__["types"].isAnyArrayBuffer(o) ? o = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(o) : ArrayBuffer.isView(o) ? o = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(o.buffer, o.byteOffset, o.byteLength) : o instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["default"] || (o instanceof Zt ? (o = ls(o), l = o.type.split("=")[1]) : o = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(String(o))));
        let u = o;
        __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].isBuffer(o) ? u = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["default"].Readable.from(o) : Xt(o) && (u = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["default"].Readable.from(o.stream())), this[N] = {
            body: o,
            stream: u,
            boundary: l,
            disturbed: !1,
            error: null
        }, this.size = a, o instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["default"] && o.on("error", (m)=>{
    ...
    async formData() {
        ...
        const { toFormData: a } = await __turbopack_context__.r("[project]/node_modules/.pnpm/node-fetch-native@1.6.6/node_modules/node-fetch-native/dist/chunks/multipart-parser.mjs [app-rsc] (ecmascript, async loader)")(__turbopack_context__.i);
...
ht.prototype.buffer = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$util__$5b$external$5d$__$28$node$3a$util$2c$__cjs$29$__["deprecate"])(ht.prototype.buffer, "Please use 'response.arrayBuffer()' instead of 'response.buffer()'", "node-fetch#buffer"), Object.defineProperties(ht.prototype, {
    body: {
        enumerable: !0
    },
    bodyUsed: {
...
async function Zr(i1) {
    if (i1[N].disturbed) throw new TypeError(`body used already for: ${i1.url}`);
    if (i1[N].disturbed = !0, i1[N].error) throw i1[N].error;
    const { body: o } = i1;
    ...
    try {
        for await (const u of o){
            if (i1.size > 0 && l + u.length > i1.size) {
                const m = new te(`content size at ${i1.url} over limit: ${i1.size}`, "max-size");
                throw o.destroy(m), m;
            }
            l += u.length, a.push(u);
        }
    } catch (u) {
        throw u instanceof Kt ? u : new te(`Invalid response body while trying to fetch ${i1.url}: ${u.message}`, "system", u);
    }
    if (o.readableEnded === !0 || o._readableState.ended === !0) try {
        return a.every((u)=>typeof u == "string") ? __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(a.join("")) : __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].concat(a, l);
    } catch (u) {
        throw new te(`Could not create Buffer from response body for ${i1.url}: ${u.message}`, "system", u);
    }
    else throw new te(`Premature close of server response while trying to fetch ${i1.url}`);
}
n(Zr, "consumeBody");
const Kr = n((i1, o)=>{
    let a, l, { body: u } = i1[N];
    if (i1.bodyUsed) throw new Error("cannot clone body after it is used");
    return u instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["default"] && typeof u.getBoundary != "function" && (a = new __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["PassThrough"]({
        highWaterMark: o
    }), l = new __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["PassThrough"]({
        highWaterMark: o
    }), u.pipe(a), u.pipe(l), i1[N].stream = a, u = l), u;
}, "clone"), ms = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$util__$5b$external$5d$__$28$node$3a$util$2c$__cjs$29$__["deprecate"])((i1)=>i1.getBoundary(), "form-data doesn't follow the spec and requires special treatment. Use alternative package", "https://github.com/node-fetch/node-fetch/issues/1167"), Io = n((i1, o)=>i1 === null ? null : typeof i1 == "string" ? "text/plain;charset=UTF-8" : Oo(i1) ? "application/x-www-form-urlencoded;charset=UTF-8" : Xt(i1) ? i1.type || null : __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].isBuffer(i1) || __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$util__$5b$external$5d$__$28$node$3a$util$2c$__cjs$29$__["types"].isAnyArrayBuffer(i1) || ArrayBuffer.isView(i1) ? null : i1 instanceof Zt ? `multipart/form-data; boundary=${o[N].boundary}` : i1 && typeof i1.getBoundary == "function" ? `multipart/form-data;boundary=${ms(i1)}` : i1 instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["default"] ? null : "text/plain;charset=UTF-8", "extractContentType"), bs = n((i1)=>{
    const { body: o } = i1[N];
    return o === null ? 0 : Xt(o) ? o.size : __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].isBuffer(o) ? o.length : o && typeof o.getLengthSync == "function" && o.hasKnownLength && o.hasKnownLength() ? o.getLengthSync() : null;
}, "getTotalBytes"), ps = n(async (i1, { body: o })=>{
    o === null ? i1.end() : await hs(o, i1);
}, "writeToStream"), er = typeof __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$http__$5b$external$5d$__$28$node$3a$http$2c$__cjs$29$__["default"].validateHeaderName == "function" ? __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$http__$5b$external$5d$__$28$node$3a$http$2c$__cjs$29$__["default"].validateHeaderName : (i1)=>{
    if (!/^[\^`\-\w!#$%&'*+.|~]+$/.test(i1)) {
...
}, Jr = typeof __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$http__$5b$external$5d$__$28$node$3a$http$2c$__cjs$29$__["default"].validateHeaderValue == "function" ? __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$http__$5b$external$5d$__$28$node$3a$http$2c$__cjs$29$__["default"].validateHeaderValue : (i1, o)=>{
    if (/[^\t\u0020-\u007E\u0080-\u00FF]/.test(o)) {
...
class ae extends URLSearchParams {
    ...
    constructor(o){
        ...
        if (o instanceof ae) {
            const l = o.raw();
            for (const [u, m] of Object.entries(l))a.push(...m.map((h)=>[
                    u,
                    h
                ]));
            ...
            if (l == null) a.push(...Object.entries(o));
                ...
                a = [
                    ...
                    if (typeof u != "object" || __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$util__$5b$external$5d$__$28$node$3a$util$2c$__cjs$29$__["types"].isBoxedPrimitive(u)) throw new TypeError("Each header pair must be an iterable object");
                    return [
                        ...u
                    ];
                }).map((u)=>{
        ...
        return a = a.length > 0 ? a.map(([l, u])=>(er(l), Jr(l, String(u)), [
    ...
    forEach(o, a = void 0) {
        for (const l of this.keys())Reflect.apply(o, a, [
            this.get(l),
            l,
            this
        ]);
...
function ys(i1 = []) {
    return new ae(i1.reduce((o, a, l, u)=>(l % 2 === 0 && o.push(u.slice(l, l + 2)), o), []).filter(([o, a])=>{
        try {
            return er(o), Jr(o, String(a)), !0;
        } catch  {
            return !1;
        }
    }));
...
const gs = new Set([
    ...
    307,
    308
]), Xr = n((i1)=>gs.has(i1), "isRedirect"), re = Symbol("Response internals");
class H extends ht {
    static{
        n(this, "Response");
    }
...
function ws(i1) {
    if (!zo.has(i1)) throw new TypeError(`Invalid referrerPolicy: ${i1}`);
    return i1;
}
...
function Ke(i1) {
    return /^about:(blank|srcdoc)$/.test(i1) || i1.protocol === "data:" || /^(blob|filesystem):$/.test(i1.protocol) ? !0 : Rs(i1);
}
n(Ke, "isUrlPotentiallyTrustworthy");
function Ts(i1, { referrerURLCallback: o, referrerOriginCallback: a } = {}) {
    if (i1.referrer === "no-referrer" || i1.referrerPolicy === "") return null;
    const l = i1.referrerPolicy;
...
const j = Symbol("Request internals"), mt = n((i1)=>typeof i1 == "object" && typeof i1[j] == "object", "isRequest"), Ps = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$util__$5b$external$5d$__$28$node$3a$util$2c$__cjs$29$__["deprecate"])(()=>{}, ".data is not a valid RequestInit property, use .body instead", "https://github.com/node-fetch/node-fetch/issues/1000 (request)");
class Xe extends ht {
    static{
        n(this, "Request");
    }
    ...
    get url() {
        return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$url__$5b$external$5d$__$28$node$3a$url$2c$__cjs$29$__["format"])(this[j].parsedURL);
    }
    get headers() {
...
const Es = n((i1)=>{
    const { parsedURL: o } = i1[j], a = new ae(i1[j].headers);
    a.has("Accept") || a.set("Accept", "*/*");
    let l = null;
    if (i1.body === null && /^(post|put)$/i.test(i1.method) && (l = "0"), i1.body !== null) {
        const S = bs(i1);
        typeof S == "number" && !Number.isNaN(S) && (l = String(S));
    }
    l && a.set("Content-Length", l), i1.referrerPolicy === "" && (i1.referrerPolicy = Ss), i1.referrer && i1.referrer !== "no-referrer" ? i1[j].referrer = Ts(i1) : i1[j].referrer = "no-referrer", i1[j].referrer instanceof URL && a.set("Referer", i1.referrer), a.has("User-Agent") || a.set("User-Agent", "node-fetch"), i1.compress && !a.has("Accept-Encoding") && a.set("Accept-Encoding", "gzip, deflate, br");
    let { agent: u } = i1;
...
var As = vs();
const Bs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$shared$2f$node$2d$fetch$2d$native$2e$DfbY2q$2d$x$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["g"])(As), { stat: tn } = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["promises"], Ws = n((i1, o)=>Do((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["statSync"])(i1), i1, o), "blobFromSync"), ks = n((i1, o)=>tn(i1).then((a)=>Do(a, i1, o)), "blobFrom"), qs = n((i1, o)=>tn(i1).then((a)=>$o(a, i1, o)), "fileFrom"), Os = n((i1, o)=>$o((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["statSync"])(i1), i1, o), "fileFromSync"), Do = n((i1, o, a = "")=>new Ze([
        new ir({
            path: o,
            size: i1.size,
...
class ir {
    ...
    async *stream() {
        ...
        yield* (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["createReadStream"])(this.#e, {
            start: this.#t,
...
async function Mo(i1, o) {
    return new Promise((a, l)=>{
        const u = new Xe(i1, o), { parsedURL: m, options: h } = Es(u);
        if (!Is.has(m.protocol)) throw new TypeError(`node-fetch cannot load ${i1}. URL scheme "${m.protocol.replace(/:$/, "")}" is not supported.`);
        if (m.protocol === "data:") {
            const g = ts(u.url), V = new H(g, {
                headers: {
        ...
        const S = (m.protocol === "https:" ? __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$https__$5b$external$5d$__$28$node$3a$https$2c$__cjs$29$__["default"] : __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$http__$5b$external$5d$__$28$node$3a$http$2c$__cjs$29$__["default"]).request, { signal: E } = u;
        let w = null;
        const A = n(()=>{
            const g = new jo("The operation was aborted.");
            l(g), u.body && u.body instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["default"].Readable && u.body.destroy(g), !(!w || !w.body) && w.body.emit("error", g);
        }, "abort");
        if (E && E.aborted) {
            A();
            return;
        ...
        b.on("error", (g)=>{
                    ...
                    case "follow":
                        {
                            ...
                            if (g.statusCode !== 303 && u.body && o.body instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["default"].Readable) {
            ...
            let I = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["pipeline"])(g, new __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["PassThrough"], (O)=>{
                O && l(O);
            });
            ...
            if (Q === "gzip" || Q === "x-gzip") {
                I = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["pipeline"])(I, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$zlib__$5b$external$5d$__$28$node$3a$zlib$2c$__cjs$29$__["default"].createGunzip(se), (O)=>{
                    O && l(O);
                }), w = new H(I, F), a(w);
                return;
            }
            if (Q === "deflate" || Q === "x-deflate") {
                const O = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["pipeline"])(g, new __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["PassThrough"], (z)=>{
                    z && l(z);
                });
                O.once("data", (z)=>{
                    (z[0] & 15) === 8 ? I = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["pipeline"])(I, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$zlib__$5b$external$5d$__$28$node$3a$zlib$2c$__cjs$29$__["default"].createInflate(), ($)=>{
                        $ && l($);
                    }) : I = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["pipeline"])(I, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$zlib__$5b$external$5d$__$28$node$3a$zlib$2c$__cjs$29$__["default"].createInflateRaw(), ($)=>{
                        $ && l($);
                    }), w = new H(I, F), a(w);
                }), O.once("end", ()=>{
                    w || (w = new H(I, F), a(w));
            ...
            if (Q === "br") {
                I = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["pipeline"])(I, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$zlib__$5b$external$5d$__$28$node$3a$zlib$2c$__cjs$29$__["default"].createBrotliDecompress(), (O)=>{
                    O && l(O);
                }), w = new H(I, F), a(w);
                return;
            }
...
`);
    ...
    i1.on("response", (h)=>{
        ...
        const S = n(()=>{
            ...
            u = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].compare(w.slice(-5), a) === 0, !u && m && (u = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].compare(m.slice(-3), a.slice(0, 3)) === 0 && __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].compare(w.slice(-2), a.slice(3)) === 0), m = w;
        }, "onData");
        h.prependListener("close", S), h.on("data", E), i1.on("close", ()=>{
...
n(Je, "Event"), Je.prototype = {
    ...
    configurable: !0,
    writable: !0
}), "undefined" < "u" && typeof window.Event < "u" && (Object.setPrototypeOf(Je.prototype, window.Event.prototype), rn.set(window.Event.prototype, Je));
function No(i1) {
    return {
        get () {
            return k(this).event[i1];
        },
        set (o) {
            k(this).event[i1] = o;
        },
...
function js(i1, o) {
    ...
    n(l, "CustomEvent"), l.prototype = Object.create(i1.prototype, {
        constructor: {
            value: l,
            configurable: !0,
            writable: !0
...
n(js, "defineWrapper");
function Ho(i1) {
    if (i1 == null || i1 === Object.prototype) return Je;
    let o = rn.get(i1);
    return o == null && (o = js(Ho(Object.getPrototypeOf(i1)), i1), rn.set(i1, o)), o;
}
n(Ho, "getWrapper");
function Ls(i1, o) {
...
n($s, "setEventPhase");
function Ms(i1, o) {
    k(i1).currentTarget = o;
}
n(Ms, "setCurrentTarget");
function Vo(i1, o) {
    k(i1).passiveListener = o;
}
...
function Us(i1) {
    return {
        ...
        set (o) {
            ...
            const a = bt(this);
            let l = null, u = a.get(i1);
            for(; u != null;)u.listenerType === tr ? l !== null ? l.next = u.next : u.next !== null ? a.set(i1, u.next) : a.delete(i1) : l = u, u = u.next;
            if (o !== null) {
                const m = {
                    listener: o,
                    listenerType: tr,
...
function Zo(i1, o) {
    Object.defineProperty(i1, `on${o}`, Us(o));
}
...
function Ko(i1) {
    ...
    for(let a = 0; a < i1.length; ++a)Zo(o.prototype, i1[a]);
    return o;
}
...
n(pe, "EventTarget"), pe.prototype = {
    ...
    removeEventListener (i1, o, a) {
        ...
        let h = null, S = l.get(i1);
        for(; S != null;){
            if (S.listener === o && S.listenerType === m) {
                h !== null ? h.next = S.next : S.next !== null ? l.set(i1, S.next) : l.delete(i1);
                return;
            }
            h = S, S = S.next;
        }
...
function xs() {
    const i1 = Object.create(nr.prototype);
    return pe.call(i1), or.set(i1, !1), i1;
}
n(xs, "createAbortSignal");
function Ns(i1) {
    or.get(i1) === !1 && (or.set(i1, !0), i1.dispatchEvent({
        type: "abort"
    }));
}
n(Ns, "abortSignal");
...
}), typeof Symbol == "function" && typeof Symbol.toStringTag == "symbol" && Object.defineProperty(nr.prototype, Symbol.toStringTag, {
    configurable: !0,
    value: "AbortSignal"
});
let nn = class {
...
var Hs = Object.defineProperty, Vs = n((i1, o)=>Hs(i1, "name", {
        value: o,
        configurable: !0
    }), "e");
const ei = Mo;
...
"[project]/node_modules/.pnpm/node-fetch-native@1.6.6/node_modules/node-fetch-native/dist/index.mjs [app-rsc] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
;
;
const o = !!globalThis.process?.env?.FORCE_NODE_FETCH, r = !o && globalThis.fetch || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetch"], p = !o && globalThis.Blob || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Blob"], F = !o && globalThis.File || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["File"], h = !o && globalThis.FormData || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["FormData"], n = !o && globalThis.Headers || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Headers"], c = !o && globalThis.Request || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Request"], R = !o && globalThis.Response || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Response"], T = !o && globalThis.AbortController || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$node$2d$fetch$2d$native$40$1$2e$6$2e$6$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AbortController"];
;
}}),

};

//# sourceMappingURL=d255e_node-fetch-native_dist_4d6618e1._.js.map